...
const Header = () => {
  ...
  return (
    <section id='page-top' className='relative flex flex-col h-screen overflow-hidden max-sm:mb-[60px]'>
      ...
      {showTickets && <Tickets onClose={() => setShowTickets(false)} />}
      ...
      <div className='grid lg:grid-cols-12 md:gap-8 md:grid-cols-6 sm:grid-cols-2 max-sm:grid-cols-2 lg:pr-0 md:pr-0 max-sm:pr-0 sm:pr-0 lg:pl-[55px] md:pl-[39px] max-sm:pl-0 sm:pl-0 md:w-auto md:mx-0 sm:w-full sm:mx-auto max-sm:w-full max-sm:mx-auto md:min-h-[85vh] max-sm:min-h-[53vh]'>
        <div className='lg:col-start-1 lg:col-span-5 md:col-start-1 md:col-span-3 flex flex-col items-center lg:justify-center md:justify-start md:relative absolute h-[85vh] z-10'>
          <a
            ...
            className='group flex md:static sm:absolute max-sm:absolute flex-col w-[24px] h-[24px] lg:ml-0 md:mr-auto md:mt-[39px] md:mb-0 max-sm:mr-auto md:ml-0 sm:ml-[60px] max-sm:ml-[60px] sm:mt-[27px] max-sm:mt-[27px] max-sm:mb-0 group cursor-pointer'>
            <img
              src="/menu.svg"
              alt="Image"
          ...
          <div className='lg:block hidden mb-0 ml-0 mr-auto translate-y-3'>
            <a className="group relative block w-[14px] h-[133px]"
            href='#current-events'>
              {/* Обычное изображение */}
              <img
                src="/podii.svg"
                alt="Image"
                className="absolute top-0 left-0 w-full h-full object-contain transition-all duration-300 group-hover:opacity-0"
              />
              ...
              <img
                src="/podii_hover.svg"
                alt="Image"
                className="absolute top-0 left-0 w-full h-full object-contain transition-all duration-300 opacity-0 group-hover:opacity-100"
              />
            </a>
          </div>
        </div>
        ...
        <div className='lg:col-start-6 lg:col-span-7 md:col-start-4 md:col-span-3 sm:col-start-1 sm:col-span-2 max-sm:col-start-1 max-sm:col-span-2 md:flex flex-col items-center justify-start relative max-sm:h-[53vh] overflow-hidden group'>
          ...
          />
          <div className='absolute md:top-[15px] sm:top-[9px] max-sm:top-[9px] md:left-0 sm:left-[47vw] max-sm:left-[43vw] flex flex-row items-center md:w-[170px] md:h-[72px] sm:w-[55px] sm:h-[61px] max-sm:w-[55px] max-sm:h-[61px]'>
            <img
              src="/namu.svg"
              alt="Image"
        ...
        <div className='hidden md:hidden sm:flex max-sm:flex flex-col sm:col-start-1 sm:col-span-2 max-sm:col-start-1 max-sm:col-span-2 w-full sm:mt-10 sm:mb-10 max-sm:mt-10 max-sm:mb-10'>
          <p className='sm:text-[45px] max-sm:text-[45px] text-center font-bold leading-[45px] text-black uppercase mx-auto'>
            Художній музей
          </p>
          <button
            onClick={(e) => {
            ...
            className=" mt-10 mx-auto w-[269px] h-[70px] md:hidden sm:flex max-sm:flex border-[#1A5A4C] border-[1px] items-center justify-between overflow-hidden relative group"
          >
