...
const Footer = () => {
  return (
    <section id='page-top' className='relative flex flex-col lg:h-[62vh] md:h-[146vh] max-sm:h-[164vh]'>
      <div className='grid lg:grid-cols-12 lg:gap-x-7 lg:gap-y-20 md:gap-x-8 max-sm:gap-x-6 max-sm:gap-y-4  md:gap-y-[70px] md:grid-cols-6 sm:grid-cols-2 max-sm:grid-cols-2 lg:pr-[55px] md:pr-[39px] max-sm:pr-[20px] sm:pr-[20px] lg:pl-[55px]  md:pl-[39px] max-sm:pl-[20px] sm:pl-[20px] md:w-auto lg:pb-[35px] max-sm:pb-[35px] pt-[47px] md:mx-0 sm:w-full sm:mx-auto max-sm:w-full max-sm:mx-auto'>
        <div className='lg:col-start-1 lg:col-span-1 md:col-start-1 md:col-span-1 max-sm:col-start-1 max-sm:col-span-2 mt-0 mb-auto flex md:flex-col max-sm:flex-row lg:items-center md:justify-center max-sm:justify-between max-sm:items-center'>
          <img
            src="/NAMU_footer.svg"
            alt="Image"
        ...
        <div className='lg:col-start-3 lg:col-span-2 md:col-start-2 md:col-span-2 max-sm:col-start-1 max-sm:col-span-1 flex flex-col items-center mt-0 max-sm:mt-[40px] mb-auto lg:justify-center max-sm:items-start '>
        ...
        <div className='lg:col-start-5 lg:col-span-2 md:col-start-4 md:col-span-2 flex flex-col items-center mt-0 mb-auto max-sm:pt-[40px] max-sm:items-start lg:justify-center '>
        ...
        <div className='lg:hidden md:col-start-1 md:col-span-6 max-sm:col-start-1 max-sm:col-span-2 max-sm:mt-14 max-sm:mb-10 md:flex max-sm:flex flex-col items-center mt-0 mb-auto justify-center'>
          <img
            src="/line_2.svg"
            alt="Image"
        ...
        <div className='lg:col-start-8 lg:col-span-2 md:col-start-2 md:col-span-2 flex flex-col items-center mt-0 max-sm:pb-16 mb-auto lg:justify-center '>
    ...
    hover:text-[#F14A27] hover:font-normal transition-all duration-500'
        ...
        <div className='lg:col-start-10 lg:col-span-2 md:col-start-4 md:col-span-2 flex flex-col items-center mt-0 max-sm:pb-16 mb-auto lg:justify-center '>
          <div className='flex flex-row w-full justify-start pb-[20px]'>
            <a
              href="#page-top"
              className='md:w-[100%] lg:text-[14px] md:leading-[21px] max-sm:text-[14px] font-normal max-sm:leading-[21px] text-[#0F0E08] font-flexsans 
    ...
    hover:text-[#F14A27] hover:font-normal transition-all duration-500'
        ...
        <div className='h-[17px] lg:col-start-1 lg:col-span-3 md:col-start-1 md:col-span-3 max-sm:col-start-1 max-sm:col-span-2 flex md:flex-row max-sm:justify-center md:justify-start lg:mt-[80px] md:mt-[20px] max-sm:mt-0 mb-0'>
          <p className='font-light lg:text-[12px] md:text-[12px] md:leading-[16px] max-sm:text-[12px] max-sm:leading-[16px] font-flexsans'>Copyright © 2019. All Rights Reserved.</p>
        </div>
        <div className='h-[17px] lg:col-start-10 lg:col-span-3 md:col-start-4 md:col-span-3 max-sm:col-start-1 max-sm:col-span-2 flex md:flex-row max-sm:justify-center md:justify-end lg:mt-[80px] md:mt-[20px] max-sm:mt-0'>
          <p className='font-light lg:text-[12px] md:text-[12px] md:leading-[16px] max-sm:text-[12px] max-sm:leading-[16px] font-flexsans'>Designed by Zhyriada Marina</p>
        </div>
